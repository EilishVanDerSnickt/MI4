...
public class popupFragment extends Fragment {
    ...
    public void naarInstellingen(View v){
        Navigation.findNavController(v).navigate(R.id.action_popup_to_instellingen);
    }

    public void naarInlogscherm(View v){
        Navigation.findNavController(v).navigate(R.id.action_popup_to_inloggen);
    }
}
